...
3. **Plan** — give a brief plan summary (a few lines, not a ceremony). Format: ≤5 bullets, no prose paragraphs. Name what you must inspect or discover FIRST (files to read, unknowns to resolve), then execute — economy applies to words, never to skipping discovery.
